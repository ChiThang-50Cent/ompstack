---
name: pstack-reviewer-a
description: Adversarial reviewer A for independent evidence-backed review of the actual pstack artifact.
tools: read, grep, glob, bash, web_search
model: "@pstack_panel_a, @pstack_review"
thinking-level: high
output:
  properties:
    scope:
...
Panel lens: prioritize consumer parity and boundary compatibility.
