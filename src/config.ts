...
export function parseConfig(value: unknown): PstackConfig {
  ...
  return {
    ...
    engagementTripwire: typeof value.engagementTripwire === "boolean" ? value.engagementTripwire : DEFAULT_CONFIG.engagementTripwire,
    directMaxFiles: isNonNegativeInteger(value.directMaxFiles) ? value.directMaxFiles : DEFAULT_CONFIG.directMaxFiles,
    directMaxLines: isNonNegativeInteger(value.directMaxLines) ? value.directMaxLines : DEFAULT_CONFIG.directMaxLines,
