...
test('doctor reports model resolution for every pstack agent', async t => {
  ...
  for (const agent of ['pstack-scout', 'pstack-architect', 'pstack-builder', 'pstack-reviewer', 'pstack-reviewer-a', 'pstack-reviewer-b', 'pstack-reviewer-c', 'pstack-judge', 'pstack-synthesizer', 'pstack-verifier']) {
