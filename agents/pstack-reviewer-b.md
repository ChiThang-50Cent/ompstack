---
name: pstack-reviewer-b
description: Adversarial reviewer B for independent evidence-backed review of the actual pstack artifact.
tools: read, grep, glob, bash, web_search
model: "@pstack_panel_b, @pstack_review"
thinking-level: high
output:
  properties:
    scope:
...
Panel lens: prioritize races and lifecycle transitions.
