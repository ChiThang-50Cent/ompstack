...
const PLAYBOOK_SIGNALS: SignalGroup[] = [
  ...
  { playbook: "orchestrate", weight: 5, patterns: [/multi[- ]day program/i, /\borchestrate\b/i, /standing coordinator/i, /program queue/i] },
  { playbook: "autopilot-full", weight: 5, patterns: [/full autopilot/i, /autopilot (?:this )?queue/i, /one owner per pr/i] },
  { playbook: "autopilot-stack", weight: 5, patterns: [/autopilot[- ]stack/i, /linear base[- ]branch stack/i, /review before landing/i] },
