...
const EXPECTED_PLAYBOOKS = [
  ...
  "review", "arena", "multi-phase", "shipping", "security", "test-repair", "dependency-upgrade", "documentation", "eval", "hillclimb", "trace-forensics", "runtime-forensics", "authoring-a-skill", "opening-a-pr", "babysit",
];
