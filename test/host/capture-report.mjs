...
const mode = process.argv[3] ?? "specialists";
const agents = mode === "writers" ? ["builder", "synthesizer"] : ["scout", "architect", "reviewer", "judge", "verifier"];
const clip = s => (s ?? "(none)").split("\n")[0].slice(0, 60).replace(/\|/g, "\\|");
console.log("| Agent | Offered tools | `bash` probe | `edit`/`write` probes |\n|---|---|---|---|");
